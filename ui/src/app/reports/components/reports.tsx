                    ...
                    {!charts ? (
                        <ZeroState title='Workflow Report'>
                            <p>
                                ...
                                <a href='https://github.com/kubeTasker'>workflow archive</a> to get long term data. Only the {limit} most recent
                                workflows are shown.
                            </p>
                            <p>Select a namespace and at least one label to get a report.</p>
                            <p>
                                <a href='https://github.com/kubeTasker'>Learn more about cost optimization</a>
                            </p>
                        </ZeroState>
                    ) : (
                        <>
